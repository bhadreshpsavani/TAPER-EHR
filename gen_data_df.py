...
if __name__ == '__main__':
    ...
    # format date time
    df_adm = pd.read_csv(os.path.join(args.path, 'ADMISSIONS.csv.gz'), compression='gzip')
    ...
    df_notes = pd.read_csv(os.path.join(args.path, 'NOTEEVENTS.csv.gz'), compression='gzip')
